...
export default mergeIds(loginId, login, {
  ...
  string: {
    ...
    SignupTitle: '' as IntlString,
    SignupSubtitle: '' as IntlString,
    AlreadyHaveAccount: '' as IntlString,
    EnterFirstName: '' as IntlString,
    EnterLastName: '' as IntlString,
    EnterEmail: '' as IntlString,
    CreatePassword: '' as IntlString,
